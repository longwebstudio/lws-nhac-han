          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-2 bg-slate-950/50 rounded-xl p-4 border border-slate-850">
              ...
              <ol className="text-xs text-slate-400 space-y-1.5 list-decimal pl-4 leading-normal">
                ...
                <li><strong className="text-cyan-400">Thêm qua URL Parameter:</strong> Bạn có thể mở ứng dụng kèm đường dẫn có tham số như: <code className="text-cyan-300 font-mono">?name=Nguyen+Van+A&phone=0912345678&insuranceCode=1234567890&expiryDate=2026-12-31</code> (thêm <code className="text-emerald-300 font-mono">&autoSave=true</code> để tự động lưu). Hỗ trợ từ khóa tiếng Việt: <code className="text-slate-300 font-mono">ten, sdt, maSo, han, loai, cccd</code>.</li>
              </ol>
            </div>
